...
export class EnhancedKQLParser {
  ...
  parseClause(tokens, startIndex) {
    ...
    switch (keyword) {
      ...
      case 'OPTIONAL': return this.parseOptionalClause(tokens, startIndex);
      case 'UNION': return this.parseUnionClause(tokens, startIndex);
      case 'NOT': return this.parseNotClause(tokens, startIndex);
      case 'GROUP': return this.parseGroupByClause(tokens, startIndex);
  ...
  /**
   * Parse field path with dot notation
   */
